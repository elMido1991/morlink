...
public class _6_1AffectationStockPhysique extends BaseDocumentExtension {
	...
	public boolean onAfterLoad() {
		...
		med.onAfterSaveTableArticle16OfCheckDispoOfStockPhysique(getWorkflowInstance());
	...
	{
		// TODO Auto-generated method stub
		if(action.getName().equals("AffecterEtValider"))
			med.setStatutQteOfMagasinier(getWorkflowInstance());
