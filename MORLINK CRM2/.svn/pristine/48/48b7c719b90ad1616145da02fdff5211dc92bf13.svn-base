...
public class _1_NouvelleLivraison extends BaseDocumentExtension {
	/**
	 * 
	 */
	...
	{
		// TODO Auto-generated method stub
		med.onPropertyChangedClientLiv(getWorkflowInstance(), property);
	...
	public boolean onAfterSubmit(IAction action)
	{
		...
		if(action.getName().equals("Valider"))
			med.onAfterSubmitLivraison(getWorkflowInstance());
