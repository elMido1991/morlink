...
public class _9_ModificationPrixADV extends BaseDocumentExtension {
	/**
	 * 
	 */
	...
	public boolean onAfterLoad()
	{
		...
		med.getArticlesToMakeDecision(getWorkflowInstance());
	...
	public boolean onAfterSubmit(IAction action)
	{
		...
		if(action.getName().equals("ModifierEtValider"))
			med.setStatutQteOfADV(getWorkflowInstance());
