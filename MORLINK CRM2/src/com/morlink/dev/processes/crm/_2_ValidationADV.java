...
public class _2_ValidationADV extends BaseDocumentExtension
{
	/**
	 * 
	 */
	...
	public boolean onAfterLoad()
	{
		...
		med.getArticlesWithDifferentPricesForTabArt2(getWorkflowInstance());
	...
	public boolean onAfterSubmit(IAction action)
	{
		...
		med.onAfterSubmitEtapeValidationADV(action, getWorkflowInstance());
